            ...
            <div class="container">
                 <div class="row">
                    <div class="col s12 m6 l6">
                        <h5 class="breadcrumbs-title" style="text-align:left;"><span><?php echo _l('Mail Box <span style="color:#bdbaba;font-size:17px">- Inbox Items</span>'); ?> <?php  ?></span></h5>
                    </div>
                    <div class="col s12 m6 l6 right-align-md">
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo admin_url(); ?>"><?php echo _l('dashboard_string'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo _l('Mail Box <span style="color:#bdbaba;font-size:17px">- Inbox Items</span>'); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
						...
						<div class="app-wrapper">
						  ...
						  <div class="card card card-default scrollspy border-radius-6 fixed-width">
							...
							<div class="collection email-collection" id="messageContent">
								...
								{
								?>
									<div class="email-brief-info collection-item" style="padding-left:5px;padding-top:35px">
										<?php  echo "No messages in the inbox."; ?>
									</div>
								<?php
								}
								else
								...
								<div class="email-brief-info collection-item">
									...
									<a class="list-content" href="<?php echo admin_url('communications/viewEmail/' . $email['uid']); ?>" >
										<div class="list-title-area">
											<div class="user-media">
												<div class="list-title">
													...
													<br>
													<p style="font-weight:normal; color:#727272">To : 
													<?= 
													...
													{
													?>
													<span style="font-weight:normal"><?= $email['subject']; ?></span>
													<?php
													}
													else
													{
